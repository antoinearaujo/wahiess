...
$reponse = $bdd->query('SELECT refModele,refTaille, refType FROM Reservation ');
?>
...
$req = $bdd->query('SELECT  COUNT(*)  refTaille FROM Reservation  ' );

$donnees = $req->fetch();
$req->closeCursor();
?>
<h4>Nombres d'articles réservés : 
<?php
