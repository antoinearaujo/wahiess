...
$reponse = $bdd->query('SELECT refModele,refTaille, refType FROM StockTotal ');
?>
...
$req = $bdd->query('SELECT  COUNT(*)  refTaille FROM StockTotal ' );

$donnees = $req->fetch();
$req->closeCursor();
?>
<h4>Nombres d'article de départ : 
<?php
