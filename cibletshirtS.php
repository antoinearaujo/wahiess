...
$reponse = $bdd->query('SELECT refModele,refTaille, refType FROM StockTotal WHERE refType = "T-Shirt" ');
?>
...
$req = $bdd->query('SELECT  COUNT(*)  refTaille FROM StockTotal WHERE refType = "T-Shirt" ' );

$donnees = $req->fetch();
$req->closeCursor();
?>
<h4>Nombres de T-Shirt de départ : 
<?php
