...
$reponse = $bdd->query('SELECT refModele,refTaille, refType FROM Reservation WHERE refType = "Sweat" ');
?>
...
$req = $bdd->query('SELECT  COUNT(*)  refTaille FROM Reservation WHERE refType = "Sweat" ' );

$donnees = $req->fetch();
$req->closeCursor();
?>
<h4>Nombres de sweats réservés : 
<?php
