...
$reponse = $bdd->query('SELECT refModele,refTaille, refType FROM StockTotal WHERE refType = "Sweat" ');
?>
...
$req = $bdd->query('SELECT  COUNT(*)  refTaille FROM StockTotal WHERE refType = "Sweat" ' );

$donnees = $req->fetch();
$req->closeCursor();
?>
<h4>Nombres de Sweat de départ : 
<?php
